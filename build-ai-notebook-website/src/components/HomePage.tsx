...
interface Props { notebooks:Notebook[]; onSelect:(id:string)=>void; onCreate:(t:string,e:string)=>string; onDelete:(id:string)=>void }
const EM=['📓','🧠','📚','🔬','💡','🎯','📊','🌍','🎨','🚀','💻','📝','🔮','⚡','🎓','🧬'];

export default function HomePage({ notebooks, onSelect, onCreate, onDelete }: Props) {
